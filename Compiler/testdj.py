...
from InfixToPostfix import infixToPostfixConv
        ...
        if next(tokenizedInput) == ":=":
            ...
            while nextValue != "." and commaFlag == 0:
                ...
                if nextValue == commaLit:
                    commaFlag = 1
                    nextValue = next(tokenizedInput)
            if re.search('[a-zA-Z+-/*]', rightSide):
                # Expression Declaration
                intermediateOutput += "EQL " + infixToPostfixConv(rightSide)
            else:
                # Variable Declaration
                intermediateOutput += "EQL " + rightSide
